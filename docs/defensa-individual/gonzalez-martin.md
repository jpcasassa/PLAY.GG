...
Forum-service : Es el espacio que se encarga de manejar y guardar las publicaciones y los comentarios de los usuarios.
Community-service : Es el espacio que se encarga de guardar la información de los clanes y la lista de jugadores que pertenecen a ellos.
Chat-service : Su entidad más importante son los mensajes que mandan los jugadores a otros.
Notificación-service : Se encarga de guardar las notificaciones clásicas, como por ejemplo ‘Tienes un mensaje pendiente’ o ‘A Juanito le ha gustado tu publicación’.
---
3) Creación:
