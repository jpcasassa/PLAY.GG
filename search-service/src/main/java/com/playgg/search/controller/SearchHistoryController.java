package com.playgg.search.controller;

import com.playgg.search.dto.*;
import com.playgg.search.service.SearchHistoryService;
...
public class SearchHistoryController {
  ...
  @PostMapping
  public ResponseEntity<SearchHistoryResponseDTO> create(
  ...
  @GetMapping
  public ResponseEntity<List<SearchHistoryResponseDTO>> findAll() {
    return ResponseEntity.ok(service.findAll());
  }

  // GET se usa para consultar informacion sin modificar datos.
  @GetMapping("/{id}")
  public ResponseEntity<SearchHistoryResponseDTO> findById(@PathVariable Long id) {
    return ResponseEntity.ok(service.findById(id));
  }

  // PUT actualiza un recurso existente identificado normalmente por su id.
  @PutMapping("/{id}")
  public ResponseEntity<SearchHistoryResponseDTO> update(
      @PathVariable Long id, @Valid @RequestBody UpdateSearchHistoryDTO dto) {
