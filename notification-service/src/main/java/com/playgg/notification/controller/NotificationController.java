package com.playgg.notification.controller;

import com.playgg.notification.dto.*;
import com.playgg.notification.service.NotificationService;
...
public class NotificationController {
  ...
  public ResponseEntity<NotificationResponseDTO> update(
      @PathVariable Long id, @Valid @RequestBody UpdateNotificationDTO dto) {
